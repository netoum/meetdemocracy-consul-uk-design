section "Creating Users" do
  ...
  admin = create_user("admin@meetdemocracy.com", "admin")
  ...
  moderator = create_user("mod@meetdemocracy.com", "moderator")
  moderator.create_moderator
  moderator.update!(residence_verified_at: Time.current,
                   confirmed_phone: Faker::PhoneNumber.phone_number, document_type: "1",
                   verified_at: Time.current, document_number: unique_document_number)

  manager = create_user("manager@meetdemocracy.com", "manager")
  manager.create_manager
  manager.update!(residence_verified_at: Time.current,
                 confirmed_phone: Faker::PhoneNumber.phone_number, document_type: "1",
                 verified_at: Time.current, document_number: unique_document_number)

  valuator = create_user("valuator@meetdemocracy.com", "valuator")
  valuator.create_valuator
  valuator.update!(residence_verified_at: Time.current,
                  confirmed_phone: Faker::PhoneNumber.phone_number, document_type: "1",
                  verified_at: Time.current, document_number: unique_document_number)

  poll_officer = create_user("poll_officer@meetdemocracy.com", "Paul O. Fisher")
  poll_officer.create_poll_officer
  poll_officer.update!(residence_verified_at: Time.current,
                      confirmed_phone: Faker::PhoneNumber.phone_number, document_type: "1",
                      verified_at: Time.current, document_number: unique_document_number)

  poll_officer2 = create_user("poll_officer2@meetdemocracy.com", "Pauline M. Espinosa")
  poll_officer2.create_poll_officer
  poll_officer2.update!(residence_verified_at: Time.current,
                       confirmed_phone: Faker::PhoneNumber.phone_number, document_type: "1",
                       verified_at: Time.current, document_number: unique_document_number)

  sdg_manager = create_user("sdg_manager@meetdemocracy.com", "SDG manager")
  sdg_manager.create_sdg_manager
  sdg_manager.update!(residence_verified_at: Time.current,
                confirmed_phone: Faker::PhoneNumber.phone_number, document_type: "1",
                verified_at: Time.current, document_number: unique_document_number)

  create_user("unverified@meetdemocracy.com", "unverified")

  level_2 = create_user("leveltwo@meetdemocracy.com", "level 2")
  ...
  verified = create_user("verified@meetdemocracy.com", "verified")
  ...
  [
    ...
    org_user = create_user("#{organization_name.parameterize}@meetdemocracy.com", organization_name)
  ...
  5.times do |i|
    official = create_user("official#{i}@meetdemocracy.com", "Official #{i}")
    official.update!(official_level: i, official_position: "Official position #{i}")
  end

  30.times do |i|
    user = create_user("user#{i}@meetdemocracy.com", "Regular user #{i}")
    level = [1, 2, 3].sample
    if level >= 2
